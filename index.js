...
var flagImage = '<i class="fa fa-flag-o"></i>';
var wrongBombImage = '<i class="fa fa-bomb"></i>'
var sizeLookup = {
      ...
      <tr>
        <td class="menu" colspan="${size}">
            <section id="status-bar">
              ...
              <div id="reset"><i class="fa fa-smile-o" aria-hidden="true"></i></div>
...
function render() {
  ...
  if (hitBomb) {
    document.getElementById('reset').innerHTML = '<i class="fa fa-smile-o"></i>';
    runCodeForAllCells(function(cell) {
